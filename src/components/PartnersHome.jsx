      ...
      <div className="container mx-auto">
        ...
        <div className='p-8 ml-12 lg:ml-24'>
              <Swiper
                ...
                <SwiperSlide><div className='lg:h-[200px] lg:flex lg:items-center lg:justify-center'><img  className='h-[59px] w-[210px]' src={jrpacking} alt="inotek" /></div></SwiperSlide>
                <SwiperSlide><div className='lg:h-[200px] lg:flex lg:items-center lg:justify-center'><img className='h-[59px] w-[210px]' src={Aligned} alt="inotek" /></div></SwiperSlide>
                <SwiperSlide><div className='lg:h-[200px] lg:flex lg:items-center lg:justify-center'><img  className='h-[59px] w-[210px]' src={linelink} alt="inotek" /></div></SwiperSlide>
                </Swiper>
         </div>
      </div>
   </div>
