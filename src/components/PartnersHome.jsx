...
//                 <SwiperSlide><div className='lg:h-[200px] lg:flex lg:items-center lg:justify-center'><img  className='h-[100px] w-[250px]' src={Linelink3inelink3} alt="inotek" /></div></SwiperSlide>
//                 </Swiper>
//          </div>
//       </div>
//    </div>
